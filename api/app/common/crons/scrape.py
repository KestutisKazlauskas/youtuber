...
class YoutubeChannelScrapeJob:
    ...
    def _count_first_hour_view(videos, range_):
        ...
        for video in videos:
            ...
            if hour > video['publishedAt'] > hour_range:
                ...
                if statistic:
                    ...
                    interval = (video['publishedAt'] + timedelta(hours=1)) - statistic.time_created
